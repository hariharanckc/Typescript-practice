...
if (isPalindrome(string1)) {
    console.log("".concat(string1, " is a palindrome"));
}
else {
    console.log("".concat(string1, " is not a palindrome"));
}
if (isPalindrome(newstring)) {
    console.log("".concat(newstring, " new string"));
}
